...
INSERT INTO `#xyh#_announce` (`id`, `title`, `content`, `starttime`, `endtime`, `status`, `posttime`) VALUES(1, '手机版网站开通', '<p>手机版网站开通，用手机版网站开通手机访问http://demo.com 即可访问手机站</p>', 0, 1525048560, 1, 1396399014);
...
INSERT INTO `#xyh#_link` (`id`, `name`, `url`, `logo`, `description`, `ischeck`, `posttime`, `sort`) VALUES(1, '友情链接', 'http://', '', '', 0, 1396255203, 1);
INSERT INTO `#xyh#_link` (`id`, `name`, `url`, `logo`, `description`, `ischeck`, `posttime`, `sort`) VALUES(2, '友情链接', 'http://', '', '', 0, 1396255203, 1);
INSERT INTO `#xyh#_link` (`id`, `name`, `url`, `logo`, `description`, `ischeck`, `posttime`, `sort`) VALUES(3, '友情链接', 'http://', '', '', 0, 1396255203, 1);
...
INSERT INTO `#xyh#_picture` (`id`, `title`, `color`, `keywords`, `litpic`, `description`, `copyfrom`, `template`, `pictureurls`, `content`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(1, '迷幻炫彩', '', '', 'http://img9.lqscms.com/201410/53391df14c069.jpg!200X200.jpg', '', '', '', 'http://img9.lqscms.com/201410/53391df14c069.jpg$$$$$$|||http://img9.lqscms.com/201410/53391deab6d3b.jpg$$$$$$|||http://img9.lqscms.com/201410/53391dee1e3e8.jpg$$$$$$', '<p>迷幻炫彩，很好看的图片</p>', 1396252161, 1396252161, 398, 8, 1, 0, '', 0, 0, 1);
...
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `marketprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(1, '皇室五件套', '', '', 'http://img9.lqscms.com/201410/533919a874460.jpg!200X200.jpg', 'http://img9.lqscms.com/201410/533919a874460.jpg$$$$$$', '<p>千年黄花梨</p><p>珍贵材种中国海南吊罗山黄花梨木高档实木皇室五件套尊贵经典，雕刻精密，结构稳定，其木纹如行云流水、质地坚韧缜密如玉，木色瑰丽动人.</p>', '', 0, 0, '云峰', '个', '标准', 1396251156, 1396251156, 10, 6, 1, 0, '', 0, 0, 1);
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `marketprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(2, '圆桌5件套', '', '', 'http://img9.lqscms.com/201410/53391ad0dbbbc.jpg!200X200.jpg', 'http://img9.lqscms.com/201410/53391ad0dbbbc.jpg$$$$$$', '<p>圆桌5件套</p><p>产地为缅甸，材质为鸡翅木</p>', '', 0, 0, '云峰', '个', '标准', 1396251333, 1396251333, 36, 6, 1, 0, '', 0, 0, 1);
INSERT INTO `#xyh#_product` (`id`, `title`, `color`, `keywords`, `litpic`, `pictureurls`, `content`, `description`, `price`, `marketprice`, `brand`, `units`, `specification`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `userid`, `aid`) VALUES(3, '吉象如意', '', '', 'http://img9.lqscms.com/201410/53391bf80a62e.jpg!200X200.jpg', 'http://img9.lqscms.com/201410/53391bf80a62e.jpg$$$$$$', '<p>阔叶黄檀，蝶形花科Fabaceae，另一拉丁学名Dalbergia emarginata Roxb是一种具备关紧经济价值的树种，在国际市场上一般叫做它为印度一种植物的花木&quot;Indian Rosewood&quot;，它主要用于制造高级家具和工艺品和扮饰材料以及医疗药品用场等。<br/>汉字学名：阔叶黄檀 <br/>拉丁学名：Fabaceae <br/>界：植物界 <br/>科：豆科 <br/>亚科：蝶形花亚科 <br/>种：黑酸枝类 <br/>散布地区范围：喜马拉雅山系以南的尼泊尔、巴基斯坦到孟加拉湾两岸。</p>', '', 0, 0, '云峰', '个', '标准', 1396251643, 1396251643, 79, 7, 1, 0, '', 0, 0, 1);
...
INSERT INTO `#xyh#_special` (`id`, `title`, `shorttitle`, `color`, `author`, `keywords`, `litpic`, `description`, `content`, `publishtime`, `updatetime`, `click`, `cid`, `commentflag`, `flag`, `jumpurl`, `status`, `filename`, `template`, `aid`) VALUES(1, '文章汇集', '', '', '', '', 'http://img9.lqscms.com/201410/53391df14c069.jpg!200X200.jpg', '文章汇集', NULL, 1398668509, 1398668509, 82, 0, 1, 1, '', 0, '', 'Special_content.html', 1);
...
INSERT INTO `#xyh#_abc_detail` (`id`, `title`, `content`, `url`, `starttime`, `endtime`, `aid`, `sort`, `status`) VALUES(1, '图片1', 'http://img9.lqscms.com/banner/p1.jpg', '#', 1416276000, 1924912800, 1, 1, 1);
INSERT INTO `#xyh#_abc_detail` (`id`, `title`, `content`, `url`, `starttime`, `endtime`, `aid`, `sort`, `status`) VALUES(2, '图片2', 'http://img9.lqscms.com/banner/p2.jpg', '#', 1416276000, 1924912800, 1, 1, 1);
...
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(1, 'CFG_WEBNAME', '网站名称', '', '', 2, 1, '#web_name#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(2, 'CFG_WEBURL', '网站域名', '', '', 2, 1, '#web_url#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(3, 'CFG_WEBTITLE', '网站标题', '站点首页title(SEO)的设置', '', 2, 1, '#web_name#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(4, 'CFG_KEYWORDS', '站点关键词', '', '', 2, 1, '#web_name#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(5, 'CFG_DESCRIPTION', '站点描述', '', '', 3, 1, '#web_name#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(6, 'CFG_THEMESTYLE', '模板风格', '', 'select', 2, 1, '#web_style#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(7, 'CFG_COOKIE_ENCODE', 'cookie加密码', '', '', 2, 1, '#web_cookie_code#', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(8, 'CFG_POWERBY', '网站版权信息', '', '', 3, 1, 'Copyright © 2014-2014 LQSCMS.  版权所有', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(9, 'CFG_STATS', '网站统计', '', '', 3, 1, '', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(10, 'CFG_BEIAN', '网站备案号', '', '', 2, 1, '', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(11, 'CFG_ADDRESS', '联系地址', '', '', 2, 1, '中国北京', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(12, 'CFG_PHONE', '联系电话', '', '', 2, 1, '0871-99999', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(13, 'CFG_WEBSITE_CLOSE', '关闭网站', '', '', 4, 2, '0', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(14, 'CFG_WEBSITE_CLOSE_INFO', '关站提示', '', '', 3, 2, '站点维护中，请稍等一会...', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(15, 'CFG_MOBILE_AUTO', '手机版开启', '', '', 4, 2, '1', 2);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(16, 'CFG_EMAIL_FROM', '发件邮箱地址', '', '', 2, 3, 'ddend@qq.com', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(17, 'CFG_EMAIL_FROM_NAME', '发件人名称', '', '', 2, 3, '站名', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(18, 'CFG_EMAIL_HOST', 'STMP服务器', '', '', 2, 3, 'smtp.exmail.qq.com', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(19, 'CFG_EMAIL_PORT', '服务器端口', '', '', 1, 3, '25', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(20, 'CFG_EMAIL_LOGINNAME', '邮箱帐号', '', '', 2, 3, 'ddend@qq.com', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(21, 'CFG_EMAIL_PASSWORD', '邮箱密码', '', '', 2, 3, '123zstQhz4', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(22, 'CFG_BADWORD', '禁用词语', '', '', 3, 2, '艾滋病|中国共产党|111111111', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(23, 'CFG_FEEDBACK_GUEST', '允许匿名评论', '', '', 4, 2, '1', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(24, 'CFG_MEMBER_OPEN', '开启会员功能', '', '', 4, 5, '1', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(25, 'CFG_MEMBER_VERIFYEMAIL', ' 开启邮件验证', '', '', 4, 5, '0', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(26, 'CFG_MEMBER_NOTALLOW', '禁止使用的昵称', '', '', 3, 5, 'www,bbs,ftp,mail,user,users,admin,administrator,lqscms', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(27, 'CFG_UPLOAD_MAXSIZE', '允许上传大小', 'KB', '', 1, 4, '2048', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(28, 'CFG_IMGTHUMB_SIZE', '缩略图组尺寸', '', '', 2, 4, '300X300', 1);
...
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(30, 'CFG_IMGTHUMB_WIDTH', '固宽缩略图组长度', '固定宽度等比缩略,如60,50', '', 2, 4, '600', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(31, 'CFG_UPLOAD_ROOTPATH', '上传根目录', '', '', 2, 4, './uploads/', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(32, 'CFG_UPLOAD_FILE_EXT', '允许附件类型', '', '', 3, 4, 'jpg,gif,png,jpeg,txt,doc,docx,xls,ppt,zip,rar,mp3', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(33, 'CFG_UPLOAD_IMG_EXT', '允许图片类型', '带缩略图的图片', '', 2, 4, 'jpg,gif,png,jpeg', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(34, 'CFG_VERIFY_REGISTER', '开启注册验证码', '', '', 4, 2, '0', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(35, 'CFG_VERIFY_LOGIN', '开启登录验证码', '', '', 4, 2, '0', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(36, 'CFG_VERIFY_GUESTBOOK', '开启留言板验证码', '', '', 4, 2, '1', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(37, 'CFG_VERIFY_REVIEW', '开启评论验证码', '', '', 4, 2, '1', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(38, 'CFG_SQL_FILESIZE', 'sql文件大小', '备份数据库，值不可太大，否则会导致内存溢出备份、恢复失败，合理大小在512K~10M间，建议3M一卷。单位字节,5M=5*1024*1024=5242880', '', 1, 6, '5242880', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(39, 'CFG_DOWNLOAD_HIDE', '隐藏下载地址', '', '', 4, 4, '0', 1);
INSERT INTO `#xyh#_config` (`id`, `name`, `title`, `remark`, `tvalue`, `typeid`, `groupid`, `value`, `sort`) VALUES(40, 'CFG_MOBILE_THEMESTYLE', '手机模板风格', '', 'select', 2, 2, 'default', 2);
