...
<body>
	...
	<div class="lqs-main">
		...
		<table class="lqs-table-base lqs-table2">
			<tr class="tr-bg">
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="text" value="lqscms" name="DB_NAME" placeholder="<?php echo $lang['install_mysql_name_intro']; ?>" /></td>

			</tr>
			<tr>
				<td class="th"><?php echo $lang['install_mysql_prefix']; ?>：</td>
				<td colspan="2"><input type="text" class="text" value="lqs_" name="DB_PREFIX" placeholder="<?php echo $lang['install_mysql_prefix_intro']; ?>" /></td>
			</tr>
			<tr class="tr-bg">
			...
			<tr>
				...
				<td colspan="2"><input type="text" class="text" value="lqscms" name="username" placeholder="<?php echo $lang['username']; ?>" /></td>
			</tr>
			<tr>
